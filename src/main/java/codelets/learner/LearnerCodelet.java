...

{
	...
	public LearnerCodelet (OutsideCommunication outc, int tWindow, int sensDim, String mode, String motivation) {
                        ...
                        // just Stage 3
                            ...
                            if(calculateMean(lastRed)>0.01 && calculateMean(lastGreen)<0.015 && calculateMean(lastBlue)<0.015){
                                try {
                                    ...
                                    Logger.getLogger(LearnerCodelet.class.getName()).log(Level.SEVERE, null, ex);
                                }
