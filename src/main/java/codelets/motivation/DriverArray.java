...
/**
 * This class represents a Driver Array. The Memory Container is responsible
 * for implementing an driver element in the Dynamic Subsumption mechanism
 ...
 * @see MemoryObject
 */
public class DriverArray extends MemoryContainer {
	 ...
	 */
	public DriverArray(String type) {
	...
	public synchronized Object getI() {
		...
		Object Ic = null;
                Object Is = null;
                ArrayList<Object> driver_values = new ArrayList<>(); // Curiosity - Survival
		double maxEvalC = 0.0d;
                double maxEvalS = 0.0d;
                
		for (Memory memory : memories) {

			double memoryEval = memory.getEvaluation();
                        Idea memory_idea = (Idea) memory.getI();
                        
			if (memoryEval >= maxEvalC && memory_idea.getName().equals("CURIOSITY")) {

				maxEvalC = memoryEval;
				Ic = memory.getI();
			} else if (memoryEval >= maxEvalS && memory_idea.getName().equals("SURVIVAL")) {
                ...
                driver_values.add(Ic);
                driver_values.add(Is);
